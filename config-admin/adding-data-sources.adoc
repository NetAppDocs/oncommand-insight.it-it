...
. Per ulteriori informazioni sulla configurazione o sulle informazioni di configurazione avanzate richieste o disponibili per l'origine dati specifica, consultare la link:vendor-specific-data-source-reference.md#["Riferimento all'origine dati specifica del vendor"].
